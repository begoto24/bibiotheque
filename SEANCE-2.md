...
**Architecture** — Respectez le découpage du projet existant : entité, repository, service, contrôleur. Aucune logique métier dans le contrôleur.

**DTO** — L'entité Reservation ne doit jamais sortir du service. Un DTO en entrée, un DTO en sortie.

**Validation** — Une requête sans livreId ou sans adherentId est refusée en 400, avec un message qui dit lequel manque.

**Gestion des erreurs** — Un identifiant inconnu renvoie 404. Une règle de gestion violée renvoie 409 avec un message qui nomme la règle enfreinte — pas « erreur serveur ».

**Documentation** — Les cinq endpoints apparaissent dans Swagger, avec leurs codes de retour.
